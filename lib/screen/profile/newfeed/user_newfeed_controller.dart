...
class UserNewfeedController extends GetxController {
  final String title = "user_newfeed";
  ...
  final loadingId = "".obs;
  UserNewfeedController(this._apiClient);
  ...
  getListPost() async {
    try {
      isLoading(true);
      final response = await _apiClient.getListUserPost(10, 1, "");
