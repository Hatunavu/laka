...
class ForgotPasswordVerifyScreen extends StatelessWidget {
  const ForgotPasswordVerifyScreen({Key? key, required this.telePhone})
      : super(key: key);
  final String telePhone;
  @override
  Widget build(BuildContext context) {
    final ForgotPasswordVerifyController controller =
        Get.put(ForgotPasswordVerifyController(getIt.get<ApiClient>()));
    print(telePhone);
    // final telephone = Get.parameters['phone'];
    controller.handleUpadatePhone(telePhone);
    return Scaffold(
        body: SafeArea(
                                      ...
                                      PinCodeTextField(
                                        ...
                                        onCompleted: (v) async {
                                          ...
                                          if (isVerifySuccess == true) {
                                            ...
                                            context.router
                                                .push(ForgotPasswordUpdatePage(
                                                    token: token))
                                                .then((value) => {
                                                      Get.delete<
                                                          ForgotPasswordUpdateController>()
                                                    });
                                          } else {
                                            return;
                                          }
