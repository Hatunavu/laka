...
class AdminOrderItem extends StatelessWidget {
  const AdminOrderItem({Key? key, required this.bookingItem, this.onBack})
      : super(key: key);
  final BookingItemModel bookingItem;
  final Function(BookingItemModel item)? onBack;
  @override
  Widget build(BuildContext context) {
    return InkWell(
        onTap: () {
          context.router
              .push(AdminOrdersDetailPage(
                  orderId: bookingItem.id,
                  isFromList: true,
                  onBack: (BookingItemModel orderItem) {
                    onBack?.call(orderItem);
                  }))
              .then((value) {
            Get.delete<AdminOrderDetailController>();
          });
        },
        child: Container(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // ),
                    Text(
                      bookingItem.vendor == null
                          ? ""
                          : bookingItem.vendor!.brandName,
                      style: titleStyle,
                    ),
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            ...
                            image: CachedNetworkImageProvider(
                              bookingItem.vendor!.thumbnail!.path ?? "",
                            ),
                            fit: BoxFit.cover)),
                  ),
                  const SizedBox(
